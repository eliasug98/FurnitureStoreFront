...
export default function ResumenProducto({producto}) {
    ...
    const { handleEditarCantidad, handleEliminarProductoPedido } = useFurniture();
    const { id, name, price, cantidad } = producto

    return (
        <div className="shadow space-y-1 p-4 bg-white mb-2">
          <div className="space-y-2">
            <p className="text-xl font-bold">{name}</p>
            <p className="text-lg font-bold ">Quantity: {cantidad}</p>
